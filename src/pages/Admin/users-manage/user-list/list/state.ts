...
class State {
    ...
    selectUsersData = async () => {
        const res: any = await service.selectUsersData({
    ...
    addUsersData = async (values = {}) => {
        const res: any = await service.addUsersData(values);
        try{
    ...
    deleteUsersData = async (id, avatar) => {
        const res: any = await service.deleteUsersData({
            id, avatar
        });
        try{
            if( res.data.code === 200 ){
    ...
    updateUsersData = async (values) => {
        const res: any = await service.updateUsersData(values);
        try{
            if( res.data.code === 200 ){
                message.success( res.data.msg );
                this.selectUsersData();         
    ...
    resetUpwdData = async (id, ukey) => {
        ...
        const res: any = await service.resetUpwdData({
            id,
